...
2. ~/.config/opencode/superpowers/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.config/opencode/superpowers/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/opencode/superpowers/worktrees/*)
    path="~/.config/opencode/superpowers/worktrees/$project/$BRANCH_NAME"
    ;;
esac
